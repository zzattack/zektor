...
namespace Zektor.Shared.USB {
    ...
    ///     base.WndProc(ref m);
    /// </summary>
    public class USBClass : IDisposable {
        ...
        /// </summary>
        public bool IsQueryHooked => deviceEventHandle != IntPtr.Zero;
        ...
        public bool RegisterForDeviceChange(bool doRegister, Form f) {
            ...
            if (doRegister) {
                ...
                if (deviceEventHandle != IntPtr.Zero) Status = Win32Wrapper.UnregisterDeviceNotification(deviceEventHandle);
            ...
            if (m.Msg == Win32Wrapper.WM_DEVICECHANGE)
                switch (m.WParam.ToInt32()) {
                    ...
                    case (int)Win32Wrapper.DBTDEVICE.DBT_DEVICEREMOVECOMPLETE:
                        ...
                        devType = (Win32Wrapper.DBTDEVTYP)Marshal.ReadInt32(m.LParam, 4);
                        if (devType == Win32Wrapper.DBTDEVTYP.DBT_DEVTYP_DEVICEINTERFACE) USBDeviceRemoved(this, new USBDeviceEventArgs());
                        break;
                }
        }
        ...
        ///     WinAPI functions
        /// </summary>
        private static class Win32Wrapper {
            ...
            /// <param name="dnDevInst">Caller-supplied device instance handle that is bound to the local machine.</param>
            /// <param name="Buffer">
            ///     Url of a buffer to receive a device instance ID string. The required buffer size can be obtained
            ///     by calling CM_Get_Device_ID_Size, then incrementing the received value to allow room for the string's terminating
            ///     NULL.
            /// </param>
            ...
            private struct DevBroadcastDeviceInterfaceBuffer {
                ...
                [FieldOffset(0)] public readonly int dbch_size;
                [FieldOffset(4)] public readonly int dbch_devicetype;
                [FieldOffset(8)] public readonly int dbch_reserved;
            }
            ...
            public struct DEV_BROADCAST_HANDLE {
                public readonly int dbch_size;
                public readonly int dbch_devicetype;
                public readonly int dbch_reserved;
                public readonly IntPtr dbch_handle;
                public readonly IntPtr dbch_hdevnotify;
                public readonly Guid dbch_eventguid;
                public readonly long dbch_nameoffset;
                public readonly byte dbch_data;
                public readonly byte dbch_data1;
            }
            ...
            public struct DEV_BROADCAST_DEVICEINTERFACE {
                ...
                public readonly int dbcc_reserved;

                [MarshalAs(UnmanagedType.ByValArray, ArraySubType = UnmanagedType.U1, SizeConst = 16)]
                public readonly byte[] dbcc_classguid;
            ...
            public struct DEV_BROADCAST_VOLUME {
                public readonly int dbcv_size;
                public readonly int dbcv_devicetype;
                public readonly int dbcv_reserved;
                public readonly int dbcv_unitmask;
                public readonly short dbcv_flags;
            }
            ...
            public struct DEV_BROADCAST_PORT {
                public readonly int dbcp_size;
                public readonly int dbcp_devicetype;
                public readonly int dbcp_reserved;

                [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)]
                public readonly char[] dbcp_name;
            }
            ...
            public struct DEV_BROADCAST_OEM {
                public readonly int dbco_size;
                public readonly int dbco_devicetype;
                public readonly int dbco_reserved;
                public readonly int dbco_identifier;
                public readonly int dbco_suppfunc;
            }
        }
